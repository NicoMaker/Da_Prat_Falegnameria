...
function createFooterHTML(data, giornoPartenza) {
  ...
  if (contatti.telefono) {
    contattiHtml +=
      '<li class="footer-item"><span class="material-icons">phone</span> <a href="tel:' +
      contatti.telefono.replace(/\s/g, "") +
      '">' +
      formatPhoneNumber(contatti.telefono) +
      "</a></li>";
  }
  if (contatti.cellulare) {
    contattiHtml +=
      '<li class="footer-item"><span class="material-icons">phone_iphone</span> <a href="tel:' +
      contatti.cellulare.replace(/\s/g, "") +
      '">' +
      formatPhoneNumber(contatti.cellulare) +
      " (Cellulare)</a></li>";
  }
  if (contatti.email) {
    contattiHtml +=
      '<li class="footer-item"><span class="material-icons">email</span> <a href="mailto:' +
      contatti.email +
      '">' +
      contatti.email +
      "</a></li>";
